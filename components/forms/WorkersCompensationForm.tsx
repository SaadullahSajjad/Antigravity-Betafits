...
import { WORKERS_COMPENSATION_FORM_DATA } from '@/constants/workersCompensationForm';
...
const WorkersCompensationForm: React.FC<Props> = ({ onSave, onSubmit, isSubmitting = false }) => {
    const [currentPage, setCurrentPage] = useState(0);
    const [values, setValues] = useState<FormValues>({});
    const [errors, setErrors] = useState<Record<string, string>>({});

    const pages = WORKERS_COMPENSATION_FORM_DATA.pages;
