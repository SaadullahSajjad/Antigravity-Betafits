...
import { PEO_EOR_ASSESSMENT_FORM_DATA } from '@/constants/peoEORAssessmentForm';
...
const PEOEORAssessmentForm: React.FC<Props> = ({ onSave, onSubmit, isSubmitting = false }) => {
    const [currentPage, setCurrentPage] = useState(0);
    const [values, setValues] = useState<FormValues>({});
    const [errors, setErrors] = useState<Record<string, string>>({});

    const pages = PEO_EOR_ASSESSMENT_FORM_DATA.pages;
...
export default PEOEORAssessmentForm;
