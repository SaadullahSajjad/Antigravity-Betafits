...
import { APPOINT_BETAFITS_FORM_DATA } from '@/constants/appointBetafitsForm';
...
const AppointBetafitsForm: React.FC<Props> = ({ onSave, onSubmit, isSubmitting = false }) => {
    const [currentPage, setCurrentPage] = useState(0);
    const [values, setValues] = useState<FormValues>({});
    const [errors, setErrors] = useState<Record<string, string>>({});

    const pages = APPOINT_BETAFITS_FORM_DATA.pages;
...
export default AppointBetafitsForm;
