...
import { QUICK_START_ALT_FORM_DATA } from '@/constants/quickStartFormAlt';
...
const QuickStartAltForm: React.FC<Props> = ({ onSave, onSubmit, isSubmitting = false }) => {
    const [currentPage, setCurrentPage] = useState(0);
    const [values, setValues] = useState<FormValues>({});
    const [errors, setErrors] = useState<Record<string, string>>({});

    const pages = QUICK_START_ALT_FORM_DATA.pages;
...
export default QuickStartAltForm;
