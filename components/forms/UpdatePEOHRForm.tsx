...
import { UPDATE_PEO_HR_FORM_DATA } from '@/constants/updatePEOHRForm';
...
const UpdatePEOHRForm: React.FC<Props> = ({ onSave, onSubmit, isSubmitting = false }) => {
    const [currentPage, setCurrentPage] = useState(0);
    const [values, setValues] = useState<FormValues>({});
    const [errors, setErrors] = useState<Record<string, string>>({});

    const pages = UPDATE_PEO_HR_FORM_DATA.pages;
...
export default UpdatePEOHRForm;
