...
import { DOCUMENT_UPLOADER_FORM_DATA } from '@/constants/documentUploaderForm';
...
const DocumentUploaderForm: React.FC<Props> = ({ onSave, onSubmit, isSubmitting = false }) => {
    const [currentPage, setCurrentPage] = useState(0);
    const [values, setValues] = useState<FormValues>({});
    const [errors, setErrors] = useState<Record<string, string>>({});

    const pages = DOCUMENT_UPLOADER_FORM_DATA.pages;
