...
import { COMPREHENSIVE_INTAKE_FORM_DATA } from '@/constants/comprehensiveIntakeForm';
...
const ComprehensiveIntakeForm: React.FC<Props> = ({ onSave, onSubmit, isSubmitting = false }) => {
    const [currentPage, setCurrentPage] = useState(0);
    const [values, setValues] = useState<FormValues>({});
    const [errors, setErrors] = useState<Record<string, string>>({});

    const pages = COMPREHENSIVE_INTAKE_FORM_DATA.pages;
