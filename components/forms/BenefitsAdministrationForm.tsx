...
const BenefitsAdministrationForm: React.FC<Props> = ({ onSave, onSubmit, isSubmitting = false }) => {
    const [currentPage, setCurrentPage] = useState(0);
    const [values, setValues] = useState<FormValues>({});
    const [errors, setErrors] = useState<Record<string, string>>({});

    const pages = BENEFITS_ADMINISTRATION_FORM_DATA.pages;
...
export default BenefitsAdministrationForm;
