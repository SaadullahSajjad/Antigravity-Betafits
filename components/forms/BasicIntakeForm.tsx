...
import { BASIC_INTAKE_FORM_DATA } from '@/constants/basicIntakeForm';
...
const BasicIntakeForm: React.FC<Props> = ({ onSave, onSubmit, isSubmitting = false }) => {
    const [currentPage, setCurrentPage] = useState(0);
    const [values, setValues] = useState<FormValues>({});
    const [errors, setErrors] = useState<Record<string, string>>({});

    const pages = BASIC_INTAKE_FORM_DATA.pages;
...
export default BasicIntakeForm;
