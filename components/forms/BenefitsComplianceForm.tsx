...
import { BENEFITS_COMPLIANCE_FORM_DATA } from '@/constants/benefitsComplianceForm';
...
const BenefitsComplianceForm: React.FC<Props> = ({ onSave, onSubmit, isSubmitting = false }) => {
    const [currentPage, setCurrentPage] = useState(0);
    const [values, setValues] = useState<FormValues>({});
    const [errors, setErrors] = useState<Record<string, string>>({});

    const pages = BENEFITS_COMPLIANCE_FORM_DATA.pages;
...
export default BenefitsComplianceForm;
