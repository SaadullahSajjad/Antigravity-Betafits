...
import { UPDATE_BROKER_ROLE_FORM_DATA } from '@/constants/updateBrokerRoleForm';
...
const UpdateBrokerRoleForm: React.FC<Props> = ({ onSave, onSubmit, isSubmitting = false }) => {
    const [currentPage, setCurrentPage] = useState(0);
    const [values, setValues] = useState<FormValues>({});
    const [errors, setErrors] = useState<Record<string, string>>({});

    const pages = UPDATE_BROKER_ROLE_FORM_DATA.pages;
...
export default UpdateBrokerRoleForm;
